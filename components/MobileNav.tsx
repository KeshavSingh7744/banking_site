    ...
    <section className="w-full max-w-[264px]">
      <Sheet>
        ...
        <SheetContent side="left" className="border-none bg-white">
          ...
          <Link href='/' className='flex cursor-pointer items-center gap-1 px-2 pt-4'> <Image src="/icons/logo.svg" width={34} height={34} alt="kodebank logo" className="mt-1" />
            <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>KodeBank</h1>
          </Link>

          <div className="mobilenav-sheet">
            <SheetClose asChild >

              <nav className="flex h-full flex-col gap-6 pt-16 text-white ml-2">
